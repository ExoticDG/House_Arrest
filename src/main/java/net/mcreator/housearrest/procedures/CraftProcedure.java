...
public class CraftProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		if (new Object() {
		...
		}.getItemStack(world, BlockPos.containing(x, y, z), 3)).getItem() == Items.BLAZE_ROD && (new Object() {
			public int getAmount(LevelAccessor world, BlockPos pos, int slotid) {
				AtomicInteger _retval = new AtomicInteger(0);
				BlockEntity _ent = world.getBlockEntity(pos);
				if (_ent != null)
		...
		}.getItemStack(world, BlockPos.containing(x, y, z), 0)).getItem() == Blocks.AIR.asItem())) {
			{
				...
				if (_ent != null) {
					final int _slotid = 0;
					final ItemStack _setstack = new ItemStack(Items.BLAZE_ROD).copy();
		...
		}.getAmount(world, BlockPos.containing(x, y, z), 0) == 0 && Crafted == true) {
			{
				BlockEntity _ent = world.getBlockEntity(BlockPos.containing(x, y, z));
				if (_ent != null) {
					final int _slotid = 1;
